...
table_rows = soup.findAll("tr") #whatever tag your looking for that you put in quotes, it will return all of them from the webpage
...
for row in table_rows[2:52]: #each element starts with td and ends with /td
    td = row.findAll("td")
    #print(td)
